...
namespace Hippo.FunctionalTests.Controllers
{
    public class AppControllerTest
    {
        ...
        public async Task EditAppStoresAllFields()
        {
            ...
            await controllerN.New(new AppNewForm { Name = "foo", StorageId = "contoso/birdsondemand" });
            ...
            var res = await controllerE.Edit(appN.Id, new AppEditForm { Id = appN.Id, Name = "bar", StorageId = "contoso/birdsdoingtheirownthing" });
