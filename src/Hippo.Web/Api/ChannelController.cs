...
namespace Hippo.Web.Api
{
    ...
    public class ChannelController : ApplicationBaseController
    {
        ...
        public async Task<ActionResult<CreateChannelResponse>> New([FromBody] CreateChannelRequest request)
        {
            try
            {
        ...
        [ProducesResponseType(typeof(GetChannelResponse), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [Produces("application/json")]
        public ActionResult<GetChannelResponse> GetById(string id)
        {
            try
            {
