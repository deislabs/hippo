...
export class StorageService {
    ...
    ): Observable<HttpResponse<StringPage>>;
    public apiStorageGet(
        searchText?: string,
        pageIndex?: number,
        pageSize?: number,
    ...
    ): Observable<HttpEvent<StringPage>>;
    public apiStorageGet(
        searchText?: string,
        pageIndex?: number,
        pageSize?: number,
        ...
        return this.httpClient.get<StringPage>(
            `${this.configuration.basePath}/api/storage`,
            {
